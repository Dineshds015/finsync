    ...
    return (
        <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="grid gap-6 md:grid-cols-2">
                <div className="space-y-2">
                    <label htmlFor="" className="text-sm font-medium">Amount</label>
                    <Input
                        type="number"
                        step="0.01"
                        placeholder="0.00"
            ...
            <div className="space-y-2">
                <label htmlFor="" className="text-sm font-medium">Category</label>
            ...
            <div className="space-y-2">
                ...
                <Popover>
                    ...
                    <PopoverContent className="w-auto p-0" algin="start">
                        <Calendar
                            mode="single"
                            selected={date}
            ...
            <div className="flex items-center justify-between rounded-lg border p-3">
                ...
                <Switch checked={isRecurring} onCheckedChange={(checked) => setValue("isRecurring", checked)} defaultValue={watch("isRecurring")} />
            </div>
            {isRecurring && (
                <div className="space-y-2">
                    <label htmlFor="" className="text-sm font-medium">Category</label>
